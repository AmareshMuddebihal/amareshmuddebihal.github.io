...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Amaresh";
        $("#favicon").attr("href","assests/images/educat/logo-no-background.png");
    }
    else {
...
s1.async=true;
s1.src='https://embed.tawk.to/65e616929131ed19d974e3e2/1ho5hhrf9';
s1.charset='UTF-8';
...
/* SCROLL EDUCATION */
// srtop.reveal('.education .box',{delay: 100}); 
